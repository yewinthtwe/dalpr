...
export default function AlprMemberForm( props ) {
    ...
    const validate = (fieldValues = values) => {
        ...
        if ('memberName' in fieldValues)
            temp.memberName = fieldValues.memberName ? "" : "Member Name is required.";
        if ('licensePlate' in fieldValues)
            temp.licensePlate = fieldValues.licensePlate ? "" : "Valid License Plate is required.";
