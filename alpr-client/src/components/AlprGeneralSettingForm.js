...
export default function AlprGeneralSettingForm( props ) {
    ...
    const validate = (fieldValues = values) => {
        ...
        if ('serverName' in fieldValues)
            temp.serverName = fieldValues.serverName ? "" : "Server Name is required.";
        ...
        if ('photoStore' in fieldValues)
            temp.photoStore = fieldValues.photoStore ? "" : "Photo Store is required.";
        if ('configuredLanes' in fieldValues)
            temp.configuredLanes = fieldValues.configuredLanes ? "" : "Number of Lanes is required.";
