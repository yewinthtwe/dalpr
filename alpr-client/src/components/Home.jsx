...
export default function Home(props) {
	...
	return (
		<AuthApi.Provider value={{ authUser, setAuthUser }}>
			<Router>
				<div className={classes.root}>
					...
					<main className={classes.content}>
						<div className={classes.toolbar} />
						<Switch>
							<Route exact path='/barcode' component={BarcodeApp} />
							<Route exact path='/kiosk' component={Kiosk} />
							<Route exact path='/control' component={SystemControl} />
							<Route exact path='/report' component={Report} />
							<Route exact path='/login' component={Login} />
							<Route exact path='/logout' component={Logout} />
							<Route exact path='/inOutRecord' component={InOutRecord} />
							<Route exact path='/member' component={Member} />
							<Route exact path='/user' component={User} />
							<Route exact path='/config' component={Config} />
							<Route exact path='/camera' component={Camera} />
							<Route exact path='/aiLane' component={AiLane} />
							<Route exact path='/ioModule' component={IoModule} />
							<Route exact path='/lane' component={Lane} />
							<Route exact path='/generalSetting' component={GeneralSetting} />
							<Route exact path='/price' component={Price} />
							<Route exact path='/obu' component={Obu} />
